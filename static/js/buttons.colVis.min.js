...
!function (a) {
    ...
    return a.extend(e.ext.buttons, {
        colvis: function (a, b) {
            ...
            var c = a.columns(b.columns).indexes().map(function (a) {
